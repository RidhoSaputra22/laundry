...
header('Content-Type: text/html; charset=utf-8'); // wajib


$title = 'Data Transaksi';
require 'koneksi.php';

$query = "SELECT transaksi.*, pelanggan.nama_pelanggan, pelanggan.telp_pelanggan, detail_transaksi.total_harga FROM transaksi INNER JOIN pelanggan ON pelanggan.id_pelanggan = transaksi.id_pelanggan INNER JOIN detail_transaksi ON detail_transaksi.id_transaksi = transaksi.id_transaksi";
