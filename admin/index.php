        ...
        <div class="col-md-4">
            <div class="card card-dark bg-secondary-gradient">
                <div class="card-body bubble-shadow">
                    <h1><?= 'Rp ' . number_format($penghasilan_bulan['penghasilan_bulan'] ?? 0); ?></h1>
                    <h5 class="op-8">Penghasilan Bulan <?= date('F'); ?></h5>
                    <div class="pull-right">
                        <h3 class="fw-bold op-8">
                            <hr>
                        </h3>
        ...
        <div class="col-md-4">
            <div class="card card-dark bg-secondary2">
                <div class="card-body curves-shadow">
                    <h1><?= 'Rp ' . number_format($penghasilan_minggu['penghasilan_minggu'] ?? 0); ?></h1>
