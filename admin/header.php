            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    ...
                    <ul class="nav nav-primary">
                        ...
                        <li class="nav-item <?php if ($title == 'Data Pengeluaran') {
                                                echo 'active';
                                            } ?>"">
                        ...
                        <li class="nav-item <?php if ($title == 'Data Pemasukan') {
                                                echo 'active';
                                            } ?>"">
                        ...
                        <li class="mx-4 mt-2">
                            <a href="logout.php" onclick="return confirm('Keluar dari halaman ini?');"
